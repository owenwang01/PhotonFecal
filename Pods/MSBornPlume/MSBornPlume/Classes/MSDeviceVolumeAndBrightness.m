...
@interface MSDeviceVolumeAndBrightness() {
    NSHashTable<id<MSDeviceVolumeAndBrightnessObserver>> *mObservers;
...
@implementation MSDeviceVolumeAndBrightness
...
- (void)_onVolumeChanged {
    if ( mObservers.count > 0 ) {
        for ( id<MSDeviceVolumeAndBrightnessObserver>observer in mObservers ) {
