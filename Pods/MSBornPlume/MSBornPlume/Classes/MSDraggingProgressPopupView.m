...
#if __has_include(<MSBornPlume/NSString+MSBornPlumeExtended.h>)
...
@interface MSDraggingProgressPopupView ()
@property (nonatomic, strong, readonly) UIView *contentView;
@property (nonatomic, strong, readonly) MSProgressSlider *progressSlider;
...
@implementation MSDraggingProgressPopupView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if ( self ) {
        ...
        [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(_updateSettings) name:MSPlumeConfigurationsDidUpdateNotification object:nil];
    }
    return self;
}
...
- (void)setStyle:(MSDraggingProgressPopupViewStyle)style {
    if ( style != _style ) {
        _style = style;
        [self _resetLayout];
    }
...
- (BOOL)isPreviewImageHidden {
    return _style != MSDraggingProgressPopupViewStyleFullscreen;
}
#pragma mark -
...
- (MSProgressSlider *)progressSlider {
    if ( _progressSlider == nil ) {
        _progressSlider = [MSProgressSlider new];
...
- (void)_resetLayout {
    switch ( _style ) {
        case MSDraggingProgressPopupViewStyleNormal:
        case MSDraggingProgressPopupViewStyleFitOnScreen:
            [self _resetLayout_normalStyle];
            break;
        case MSDraggingProgressPopupViewStyleFullscreen:
