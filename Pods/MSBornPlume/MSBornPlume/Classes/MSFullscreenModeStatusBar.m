...
@interface MSFullscreenModeStatusBar ()
...
@implementation MSFullscreenModeStatusBar
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if ( self ) {
...
- (void)_reload {
    ...
    switch ( _networkStatus ) {
        case MSNetworkStatus_NotReachable:
            _networkStatusLabel.text = strings.noNetWork;
            break;
        case MSNetworkStatus_ReachableViaWWAN:
            _networkStatusLabel.text = strings.cellularNetwork;
            break;
        case MSNetworkStatus_ReachableViaWiFi:
