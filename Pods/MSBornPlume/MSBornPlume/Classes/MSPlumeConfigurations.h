...
@class UIImage, UIColor, UIFont, MSPlumeConfigurations;
@protocol MSPlumeControlLayerResources, MSPlumeLocalizedStrings;

NS_ASSUME_NONNULL_BEGIN
UIKIT_EXTERN NSNotificationName const MSPlumeConfigurationsDidUpdateNotification;

@interface MSPlumeConfigurations : NSObject
+ (instancetype)shared;
///
/// 更新
///
...
@property (nonatomic, strong, null_resettable) id<MSPlumeLocalizedStrings> localizedStrings;

@property (nonatomic, strong, null_resettable) id<MSPlumeControlLayerResources> resources;
...
@protocol MSPlumeControlLayerResources <NSObject>
...
@protocol MSPlumeLocalizedStrings <NSObject>
