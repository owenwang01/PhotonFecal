...
@implementation MSPlumeResourceLoader
...
+ (void)initialize {
    ...
    dispatch_once(&onceToken, ^{
        bundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[self class]] pathForResource:@"MSPlume" ofType:@"bundle"]];
