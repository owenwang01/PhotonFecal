...
@protocol MSProgressSliderDelegate;

@interface MSProgressSlider : UIView

@property (nonatomic, weak) id <MSProgressSliderDelegate>delegate;
...
@property (nonatomic, copy, nullable) void(^tappedExeBlock)(MSProgressSlider *slider, CGFloat location);
...
@interface MSProgressSlider (Prompt)
...
#pragma mark - Border
@interface MSProgressSlider (Border)
...
@interface MSProgressSlider (Buffer)
...
@interface MSProgressSlider (StopNode)
...
@protocol MSProgressSliderDelegate <NSObject>
...
- (void)sliderDidDrag:(MSProgressSlider *)slider __deprecated_msg("use `slider:valueDidChange:`");
@end
