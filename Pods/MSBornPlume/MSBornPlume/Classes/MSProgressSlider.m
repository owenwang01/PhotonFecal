...
@interface MSProgressSliderImageView : UIImageView
@property (nonatomic, copy) void(^setImageExeBlock)(MSProgressSliderImageView *imageView);
@end

@implementation MSProgressSliderImageView
...
#pragma mark -
@implementation MSProgressSlider {
...
- (void)_setupView {
    ...
    MSProgressSliderImageView *(^makeImageView)(void) = ^MSProgressSliderImageView *{
        MSProgressSliderImageView *imageView = [MSProgressSliderImageView new];
    ...
    [(MSProgressSliderImageView *)_thumbImageView setSetImageExeBlock:^(MSProgressSliderImageView * _Nonnull imageView) {
