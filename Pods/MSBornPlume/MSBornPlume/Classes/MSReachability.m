...
static NSNotificationName const MSReachabilityNetworkStatusDidChangeNotification = @"MSReachabilityNetworkStatusDidChange";
...
@interface MSReachabilityObserver : NSObject<MSReachabilityObserver>
- (instancetype)initWithReachability:(MSReachability *)reachability;
@end

@interface MSReachability ()
...
- (id<MSReachabilityObserver>)getObserver {
    return [[MSReachabilityObserver alloc] initWithReachability:self];
}
...
- (void)setNetworkStatus:(MSNetworkStatus)networkStatus {
    _networkStatus = networkStatus;
    [NSNotificationCenter.defaultCenter postNotificationName:MSReachabilityNetworkStatusDidChangeNotification object:self];
}
@end

@implementation MSReachabilityObserver {
    __weak MSReachability *_reachability;
}
...
- (instancetype)initWithReachability:(MSReachability *)reachability {
    ...
    [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(networkStatusDidChange:) name:MSReachabilityNetworkStatusDidChangeNotification object:reachability];
...
- (void)networkStatusDidChange:(NSNotification *)note {
    id<MSReachability> mgr = note.object;
