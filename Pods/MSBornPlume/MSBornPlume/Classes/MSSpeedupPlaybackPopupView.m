...
@interface MSSpeedupPlaybackPopupView ()
...
@implementation MSSpeedupPlaybackPopupView
...
- (void)setRate:(CGFloat)rate {
    if ( rate != _rate ) {
        ...
        _textLayer.bounds = (CGRect){0, 0, [text ms_textSize]};
