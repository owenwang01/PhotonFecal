...
@interface MSViewControllerManager ()
@end

@implementation MSViewControllerManager {
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    [_rotationManager rotate:MSOrientation_Portrait animated:YES completionHandler:^(id<MSRotationManager>  _Nonnull mgr) {
...
- (void)setNeedsStatusBarAppearanceUpdate {
    ...
    if ( [_rotationManager isKindOfClass:MSRotationManager.class] && _rotationManager.isFullscreen ) {
        MSRotationManager *rotationManager = (id)_rotationManager;
